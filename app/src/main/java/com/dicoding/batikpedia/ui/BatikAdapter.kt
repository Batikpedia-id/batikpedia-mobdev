...
class BatikAdapter(private var mList: List<BatikData>) :
    RecyclerView.Adapter<BatikAdapter.LanguageViewHolder>() {
    ...
    fun setFilteredList(mList: List<BatikData>) {
        this.mList = mList
